...
export const MODEL_SOURCES: EntitySource[] = [
    ...
    { key: 'openrouter', label: 'OpenRouter', description: 'Public /api/v1/models endpoint with routing, pricing, context, and parameters.', status: 'available' },
    { key: 'openai', label: 'OpenAI', description: '/v1/models for current API-accessible model IDs and owners.', status: 'available' },
    { key: 'anthropic', label: 'Anthropic', description: '/v1/models for Claude models, release order, pagination, and model types.', status: 'available' },
    ...
    { key: 'mistral', label: 'Mistral AI', description: '/v1/models with capabilities, context length, aliases, and deprecations.', status: 'available' },
    { key: 'cohere', label: 'Cohere', description: '/v1/models with endpoints, context length, features, and tokenizer URLs.', status: 'planned' },
    { key: 'groq', label: 'Groq', description: 'OpenAI-compatible /openai/v1/models with active models and context windows.', status: 'available' },
    { key: 'together', label: 'Together AI', description: '/v1/models for hosted open models, modalities, pricing, and ownership.', status: 'available' },
    { key: 'fireworks', label: 'Fireworks AI', description: 'Serverless model catalog and account model metadata for base models and LoRAs.', status: 'available' },
    { key: 'deepinfra', label: 'DeepInfra', description: 'Hosted open model catalog across LLM, image, speech, OCR, and embeddings.', status: 'available' },
    ...
    { key: 'cerebras', label: 'Cerebras', description: 'Hosted fast-inference model list and OpenAI-compatible provider metadata.', status: 'available' },
    { key: 'xai', label: 'xAI', description: 'Grok API model endpoint for current hosted model IDs.', status: 'available' },
    { key: 'perplexity', label: 'Perplexity', description: 'Sonar model catalog, online-search capability metadata, and pricing pages.', status: 'available' },
...
export const MCP_SOURCES: EntitySource[] = [
    ...
    { key: 'github', label: 'GitHub Topics', description: 'Repos tagged mcp-server / modelcontextprotocol.', status: 'available' },
    { key: 'packages', label: 'npm Registry', description: 'Packages with mcp-server / modelcontextprotocol keywords.', status: 'available' },
    ...
    { key: 'glama', label: 'Glama', description: 'Large community index with connectors, tool schemas, quality scoring, and gateway metadata.', status: 'available' },
    ...
    { key: 'pypi', label: 'PyPI', description: 'Python package search for mcp-server and modelcontextprotocol keywords.', status: 'available' },
...
export const SKILL_SOURCES: EntitySource[] = [
    ...
    { key: 'anthropic-skills', label: 'Anthropic Skills', description: 'Official Claude skills and example SKILL.md packages.', status: 'available' },
    { key: 'cowork-plugins', label: 'Cowork Plugins', description: 'knowledge-work-plugins marketplace for brand voice, productivity, and workflows.', status: 'available' },
    ...
    { key: 'github-skills', label: 'GitHub Topics', description: 'Repos tagged claude-code-skills, claude-skills, agent-skills, and system-prompts.', status: 'available' },
