...
export type Model = { id: string; name: string; description?: string | null; provider?: string | null; domain: Domain; source: string; url?: string | null; repo?: string | null; license: LicenseInfo; pricing?: Pricing[]; updated_at?: string | null; release_date?: string | null; tags?: string[]; parameters?: string | null; context_window?: string | null; indemnity?: "None" | "VendorProgram" | "EnterpriseOnly" | "Unknown"; data_provenance?: string | null; usage_restrictions?: string[]; hosting: Hosting; downloads?: number | null; benchmarks?: BenchmarkEntry[]; analytics?: Analytics; isFavorite?: boolean; };
